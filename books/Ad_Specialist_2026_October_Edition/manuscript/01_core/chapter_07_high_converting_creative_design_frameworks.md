...
> [!WARNING]
> **Ad Policy Compliance Gate**: Never use unrealistic physical transformations (especially in health, weight loss, or skincare) that violate Meta or Google Ad Policies. Focus on **workflow, system, dashboard, or environmental transformations** (e.g. Messy messy code vs. Clean architecture; 2.1 ROAS vs. 5.8 ROAS).
